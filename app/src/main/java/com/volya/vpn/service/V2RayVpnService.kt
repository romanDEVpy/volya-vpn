...
import com.volya.vpn.contracts.Tun2SocksControl
...
//        saveVpnNetworkInfo(configName, info)
        ...
        if (isForced) {
            //stopSelf has to be called ahead of mInterface.close(). otherwise volya core cannot be stooped
            //It's strage but true.
            //This can be verified by putting stopself() behind and call stopLoop and startLoop
            //in a row for several times. You will find that later created volya core report port in use
            //which means the first volya core somehow failed to stop and release the port.
            stopSelf()
