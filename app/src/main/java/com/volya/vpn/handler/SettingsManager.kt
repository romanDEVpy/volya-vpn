...
import com.volya.vpn.AppConfig.ANG_PACKAGE
import com.volya.vpn.AppConfig.DEFAULT_SUBSCRIPTION_ID
import com.volya.vpn.AppConfig.GEOIP_PRIVATE
import com.volya.vpn.AppConfig.GEOSITE_PRIVATE
import com.volya.vpn.AppConfig.TAG_DIRECT
import com.volya.vpn.AppConfig.VPN
...
import com.volya.vpn.enums.Language
import com.volya.vpn.enums.RoutingType
import com.volya.vpn.enums.VpnInterfaceAddressConfig
import com.volya.vpn.handler.MmkvManager.decodeAllServerList
import com.volya.vpn.handler.MmkvManager.decodeServerConfig
import com.volya.vpn.handler.MmkvManager.decodeSubsList
import com.volya.vpn.handler.MmkvManager.decodeSubscription
import com.volya.vpn.handler.MmkvManager.encodeSubscription
import com.volya.vpn.handler.MmkvManager.removeSubscription
...
object SettingsManager {
    ...
    fun routingRulesetsBypassLan(): Boolean {
        ...
        if (config.configType == EConfigType.CUSTOM) {
            ...
            val volyaConfig = JsonUtil.fromJson(raw, V2rayConfig::class.java)
            val exist = volyaConfig?.routing?.rules?.filter { it.outboundTag == TAG_DIRECT }?.any {
