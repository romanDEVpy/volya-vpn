...
import com.volya.vpn.extension.toSpeedString
import com.volya.vpn.ui.MainActivity
...
object NotificationManager {
    ...
    private const val NOTIFICATION_PENDING_INTENT_STOP_VOLYA = 1
    private const val NOTIFICATION_PENDING_INTENT_RESTART_VOLYA = 2
    ...
    fun showNotification(currentConfig: ProfileItem?) {
        ...
        val stopV2RayPendingIntent = PendingIntent.getBroadcast(service, NOTIFICATION_PENDING_INTENT_STOP_VOLYA, stopV2RayIntent, flags)

        val restartV2RayIntent = Intent(AppConfig.BROADCAST_ACTION_SERVICE)
        restartV2RayIntent.`package` = AppConfig.ANG_PACKAGE
        restartV2RayIntent.putExtra("key", AppConfig.MSG_STATE_RESTART)
        val restartV2RayPendingIntent = PendingIntent.getBroadcast(service, NOTIFICATION_PENDING_INTENT_RESTART_VOLYA, restartV2RayIntent, flags)
