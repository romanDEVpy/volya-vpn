...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/2dust/volyaVPN"
    const val APP_API_URL = "https://api.github.com/repos/2dust/volyaVPN/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/2dust/volyaVPN/master/CR.md"
...
//    const val IP_API_URL = "https://speed.cloudflare.com/meta"
    ...
    const val RAY_NG_CHANNEL_NAME = "volyaVPN Background Service"
    ...
    val GEO_FILES_SOURCES = arrayListOf(
        "Loyalsoldier/volya-rules-dat",
        "runetfreedom/russia-volya-rules-dat",
        "Chocolate4U/Iran-volya-rules"
    )
